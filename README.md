# tfgm-telescope
https://dtylam.github.io/tfgm-telescope

A simple web app for search by VehicleID on the Transport for Greater Manchester (TfGM) network.
...
TfGM open data API (https://developer.tfgm.com/)
